...
const LeCarousel = (props) => {
	...
	return (
		<>
			...
			>
				<SwiperSlide>
					<img className={classes.imgDeSwiper} src={image1} alt="" />
				</SwiperSlide>
				<SwiperSlide>
					<img className={classes.imgDeSwiper} src={image2} alt="" />
				</SwiperSlide>
				<SwiperSlide>
					<img className={classes.imgDeSwiper} src={image3} alt="" />
				</SwiperSlide>
				<SwiperSlide>
					<img className={classes.imgDeSwiper} src={image4} alt="" />
				</SwiperSlide>
				<SwiperSlide>
					<img className={classes.imgDeSwiper} src={image5} alt="" />
				</SwiperSlide>
			</Swiper>
		</>
	);
